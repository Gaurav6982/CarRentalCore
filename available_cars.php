                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="backend/customers/rent_car.php" method="POST">
                                    ...
                                    <button type="submit" name="rent_car" class=" btn btn-sm btn-warning">Rent Car</button>
                                    </div>
                            </form>
                                <?php } else{ ?>
                                    <div class="d-flex justify-content-end">
                                <a href="login_customers.php" name="rent_car" class="float-right btn btn-sm btn-warning">Rent Car</a>
                                </div>
                                <?php } ?>
                            </div>
                            </div>
